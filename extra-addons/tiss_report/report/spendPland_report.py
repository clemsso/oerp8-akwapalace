...
class spendPlan_report(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(spendPlan_report, self).__init__(cr, uid, name, context=context)
...
class report_spendPlan(osv.AbstractModel):
    _name = 'report.tiss_report.report_spendPlan'
    _inherit = 'report.abstract_report'
    _template = 'tiss_report.report_spendPlan'
    _wrapped_report_class = spendPlan_report
