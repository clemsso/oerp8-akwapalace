...
class GhssPettyCash(models.Model):
    ...
    project_id = fields.Many2one('hr.contract.project.template', string="Project", required=False)
    petty_cash_limit = fields.Float(string='Max Limit', required=False)
    petty_cash_min = fields.Float(string='Min Limit', required=False, help="To Make a need of money")
